...
public class DefaultDomainFactoryTestCase extends AbstractDomainTestCase {
  ...
  private final ArtifactPluginDescriptorLoader pluginDescriptorLoader = mock(ArtifactPluginDescriptorLoader.class);
  private final ArtifactPluginRepository artifactPluginRepository = mock(ArtifactPluginRepository.class);
  ...
  private final DefaultDomainFactory domainFactory = new DefaultDomainFactory(
                                                                              ...
                                                                              null,
                                                                              serviceRepository, pluginDescriptorLoader,
